...
def create_recipe(user, **params):
    """Create and return a sameple recipe"""
    defaults = {
...
class PrivateRecipeAPITest(TestCase):
    ...
    def test_filter_by_ingredients(self):
        """Test iltering recipies by ingredients"""
        r1 = create_recipe(user=self.user, title='Posh beands on toast')
